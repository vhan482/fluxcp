...
<div class="alert alert-warning" role="alert">There is no pincode set! Please login via the game client now to secure your account.</div>
<?php endif ?>

<div class="row justify-content-md-center">
	<div class="col-12 col-lg-10 table-responsive">
	<table class="table table-borderless side collapse-responsive">
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('UsernameLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('UsernameLabel')) ?>"><?php echo htmlspecialchars($account->userid) ?></td>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountIdLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountIdLabel')) ?>">
		...
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('EmailAddressLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('EmailAddressLabel')) ?>">
			...
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountGroupIDLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountGroupIDLabel')) ?>"><?php echo (int)$account->group_id ?></td>
		</tr>
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('GenderLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('GenderLabel')) ?>">
			...
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountStateLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountStateLabel')) ?>">
		...
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('LoginCountLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('LoginCountLabel')) ?>"><?php echo number_format((int)$account->logincount) ?></td>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('CreditBalanceLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('CreditBalanceLabel')) ?>">
		...
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountBirthdateLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountBirthdateLabel')) ?>"><?php echo $account->birthdate ?></td>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('VIPStateLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('VIPStateLabel')) ?>">
				<?php echo $vipexpires ?>
			</td>
		</tr>
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('LastLoginDateLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('LastLoginDateLabel')) ?>">
			...
			<th scope="col"><?php echo htmlspecialchars(Flux::message('LastUsedIpLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('LastUsedIpLabel')) ?>">
		...
		<?php if ($showTempBan): ?>
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountViewTempBanLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewTempBanLabel')) ?>" colspan="3">
				<form action="<?php echo $this->urlWithQs ?>" method="post">
					<input type="hidden" name="tempban" value="1" />
					<textarea class="form-control" name="reason" class="block reason" placeholder="<?php echo htmlspecialchars(Flux::message('AccountBanReasonLabel')) ?>"></textarea>
					<label><?php echo htmlspecialchars(Flux::message('AccountBanUntilLabel')) ?></label>
	      			<div class="custom-control-inline">
					<?php
		      			$t = str_replace(array('<span class="date-field">', '<span class="date-time-field">', '</span>'), '', $this->dateTimeField('tempban', date('H:i:s')));
		      			echo preg_replace("/(\<select)/", "$1 class='form-control nowidth custom-select-sm xsm'", $t);
		      			// echo $this->dateTimeField('tempban', date('H:i:s'));
		      		?>
		      		</div>
					<input class="btn btn-primary btn-sm" type="submit" value="<?php echo htmlspecialchars(Flux::message('AccountTempBanButton')) ?>" onclick="return confirm('<?php echo $banconfirm ?>')" />
				</form>
			</td>
		</tr>
		<?php endif ?>
		<?php if ($showPermBan): ?>
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountViewPermBanLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewPermBanLabel')) ?>" colspan="3">
				<form action="<?php echo $this->urlWithQs ?>" method="post">
					<input type="hidden" name="permban" value="1" />
					<textarea class="form-control" name="reason" class="block reason" placeholder="<?php echo htmlspecialchars(Flux::message('AccountBanReasonLabel')) ?>"></textarea>
					<input class="btn btn-primary btn-sm" type="submit" value="<?php echo htmlspecialchars(Flux::message('AccountPermBanButton')) ?>" onclick="return confirm('<?php echo $banconfirm ?>')" />
				</form>
			</td>
		</tr>
		<?php endif ?>
		<?php if ($showUnban): ?>
		<tr>
			<th scope="col"><?php echo htmlspecialchars(Flux::message('AccountViewUnbanLabel')) ?></th>
			<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewUnbanLabel')) ?>" colspan="3">
				<form action="<?php echo $this->urlWithQs ?>" method="post">
					<input type="hidden" name="unban" value="1" />
				<?php if ($tempBanned && $auth->allowedToTempUnbanAccount): ?>
					<textarea class="form-control" name="reason" class="block reason" placeholder="<?php echo htmlspecialchars(Flux::message('AccountBanReasonLabel')) ?>"></textarea>
					<input class="btn btn-primary btn-sm" type="submit" value="<?php echo htmlspecialchars(Flux::message('AccountTempUnbanButton')) ?>" />
				<?php elseif ($permBanned && $auth->allowedToPermUnbanAccount): ?>
					<textarea class="form-control" name="reason" class="block reason" placeholder="<?php echo htmlspecialchars(Flux::message('AccountBanReasonLabel')) ?>"></textarea>
					<input class="btn btn-primary btn-sm" type="submit" value="<?php echo htmlspecialchars(Flux::message('AccountPermUnbanButton')) ?>" />
				<?php endif ?>
				</form>
			</td>
		</tr>
	...
	<h4><span class="title-line"><?php echo htmlspecialchars(sprintf(Flux::message('AccountBanLogSubHeading'), $account->userid)) ?></span></h4 class="text-bold">
	<table class="table table-borderless table-striped collapse-responsive">
		<thead>
			<tr>
		...
		<tbody>
			<tr>
				<td data-label="<?php echo htmlspecialchars(Flux::message('BanLogBanTypeLabel')) ?>">
					<?php echo htmlspecialchars($this->banTypeText($ban->ban_type)) ?></td>
				<td data-label="<?php echo htmlspecialchars(Flux::message('BanLogBanDateLabel')) ?>">
					<?php echo htmlspecialchars($this->formatDateTime($ban->ban_date)) ?></td>
				<td data-label="<?php echo htmlspecialchars(Flux::message('BanLogBanReasonLabel')) ?>">
					<?php echo nl2br(htmlspecialchars($ban->ban_reason)) ?></td>
				<td data-label="<?php echo htmlspecialchars(Flux::message('BanLogBannedByLabel')) ?>">
					<?php if ($ban->userid): ?>
	...
	<?php foreach ($characters as $serverName => $chars): $zeny = 0; ?>
		<h4><span class="title-line"><?php echo htmlspecialchars(sprintf(Flux::message('AccountViewCharSubHead'), $serverName)) ?></span></h4>
		<?php if ($chars): ?>
		<table class="table table-borderless table-striped collapse-responsive">
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewSlotLabel')) ?>" align="right"><?php echo $char->char_num+1 ?></td>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewCharLabel')) ?>">
					...
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewClassLabel')) ?>"><?php echo htmlspecialchars($this->jobClassText($char->class)) ?></td>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewLvlLabel')) ?>"><?php echo (int)$char->base_level ?></td>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewJlvlLabel')) ?>"><?php echo (int)$char->job_level ?></td>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewZenyLabel')) ?>"><?php echo number_format((int)$char->zeny) ?></td>
					<?php if ($char->guild_name): ?>
						<?php if ($char->guild_emblem_len): ?>
						<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewGuildLabel')) ?>">
							<img src="<?php echo $this->emblem($char->guild_id) ?>" /></td>
						<?php endif ?>
						<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewGuildLabel')) ?>"
							<?php if (!$char->guild_emblem_len) echo ' colspan="2"' ?>>
					...
					<?php else: ?>
						<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewGuildLabel')) ?>" colspan="2" align="center"><span class="not-applicable"><?php echo htmlspecialchars(Flux::message('NoneLabel')) ?></span></td>
					<?php endif ?>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewStatusLabel')) ?>">
						<?php if ($char->online): ?>
					...
					<?php if (($isMine || $auth->allowedToModifyCharPrefs) && $auth->actionAllowed('character', 'prefs')): ?>
					<td data-label="<?php echo htmlspecialchars(Flux::message('AccountViewPrefsLabel')) ?>">
...
<h4><span class="title-line"><?php echo htmlspecialchars(sprintf(Flux::message('AccountViewStorage'), $account->userid)) ?></span></h4>
<?php if ($items): ?>
	<p><?php echo htmlspecialchars(sprintf(Flux::message('AccountViewStorageCount'), $account->userid, count($items))) ?></p>
	<table class="data-tables table table-borderless table-striped" class="display" style="width:100%">
        <thead>
			<tr>
				<th class="all">ID<?php //echo htmlspecialchars(Flux::message('ItemIdLabel')) ?></th>
				<th class="all"><?php echo htmlspecialchars(Flux::message('ItemNameLabel')) ?></th>
				<th class="min-tablet">Qty<?php // echo htmlspecialchars(Flux::message('ItemAmountLabel')) ?></th>
				<th class="min-tablet"><?php echo htmlspecialchars(Flux::message('ItemIdentifyLabel')) ?></th>
				<th class="min-tablet"><?php echo htmlspecialchars(Flux::message('ItemBrokenLabel')) ?></th>
				<th class="all"><?php echo htmlspecialchars(Flux::message('ItemCard0Label')) ?></th>
				<th class="min-tablet"><?php echo htmlspecialchars(Flux::message('ItemCard1Label')) ?></th>
				<th class="min-tablet"><?php echo htmlspecialchars(Flux::message('ItemCard2Label')) ?></th>
				<th class="min-tablet"><?php echo htmlspecialchars(Flux::message('ItemCard3Label')) ?></th>
				<th class="min-tablet">Extra</th>
			</tr>
		</thead>
		<tbody>
